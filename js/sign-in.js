const btnSignUp = document.querySelectorAll(".btn_sign-up");
const logInBtn = document.querySelectorAll(".log_in_btn");
const nameOfUser = document.getElementById("name");
const niknameOfUser = document.getElementById("nikname");
const birthOfUser = document.getElementById("date of birth");
